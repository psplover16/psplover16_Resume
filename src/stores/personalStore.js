    ...
    workExperience: [
      {
        ...
        period: '2024.06 - 至今',
        description:
          '負責前端架構設計與開發，使用 Vue.js、Tailwind 等現代化框架建構使用者介面。',
        achievements: ['建立可重複使用的組件庫', '優化網站效能提升'],
        skills: ['Vue.js', 'Copilot', 'Git', 'Echart'],
      },
      {
        id: 2,
        position: '工程師主任',
        company: '久益立數位科技有限公司(110/11-112/9)',
        period: '2021.11 - 2023.09',
        description: '遊戲公司，員工幾乎都是前公司移轉過來',
        achievements: [
          '專案分配與進度管理',
          'Cocos2D遊戲開發',
          '視訊機台開發及維護',
      ...
      },
      {
        ...
        skills: ['Vue.js', 'jQuery', 'Canvas', 'tui.image-editor', 'webpack'],
      },
    ],
